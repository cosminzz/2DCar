...
public class UiManager {
    ...
    //Character objects
    NpC player;
    NpC spawnObj1, spawnObj2, spawnObj3, spawnObj4, spawnObj5;
    ...
    public void display(Stage primaryStage) {
        ...
        spawnObj1.theNpc("sample/coin.png", 50, 50, npcSpawnPos(), 50);
        spawnObj2.theNpc("sample/coin1.png", 50, 50, npcSpawnPos(), 300);
        spawnObj3.theNpc("sample/car.png", 50, 50, npcSpawnPos(), 500);
        spawnObj4.theNpc("sample/coin3.png", 50, 50, npcSpawnPos(), 0);//-npcYPositionHolder.get(random.nextInt(npcYPositionHolder.size()))
        spawnObj5.theNpc("sample/back.png", sceneHeight, sceneWidth, 0, 0);

        // Add characters to the layout
        layout.getChildren().add(spawnObj5.imageView);
